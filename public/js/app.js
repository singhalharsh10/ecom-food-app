...
function updateCart(pizza) {
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/update-cart', pizza).then(function (res) {
    // console.log(res)
    cartCounter.innerText = res.data.totalQty, new noty__WEBPACK_IMPORTED_MODULE_1___default.a({
      type: 'success',
      timeout: 1000,
...
if (order) {
  socket.emit('join', "order_".concat(order._id)); // order_dffwwrefvvfesdfddf
}
...
__webpack_require__(/*! E:\NodeJS\Projects\ecom-food-app-master\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! E:\NodeJS\Projects\ecom-food-app-master\resources\scss\app.scss */"./resources/scss/app.scss");
